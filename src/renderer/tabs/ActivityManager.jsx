...
export function ActivityManager({ theme }) {
    ...
    return (
        <FlexAlign options={{ direction: 'vertical', align: 'start', justify: 'center' }} style={{ width: '100%', height: '100%', gap: 12 }}>
            ...
            <FlexAlign options={{ direction: 'vertical', align: 'start', justify: 'center' }} style={{ gap: 12 }}>
                <FlexAlign options={{ direction: 'vertical', align: 'start', justify: 'center' }} style={{ width: '100%', height: null, background: t.cardBackground, boxSizing: 'border-box', padding: 22, borderRadius: 22, gap: 12, border: t.border }}>
